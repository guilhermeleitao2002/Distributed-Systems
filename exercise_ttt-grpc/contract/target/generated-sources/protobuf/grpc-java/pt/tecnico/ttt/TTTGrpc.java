...
public final class TTTGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pt.tecnico.ttt.TransposeRequest,
      pt.tecnico.ttt.TransposeResponse> getTransposeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Transpose",
      requestType = pt.tecnico.ttt.TransposeRequest.class,
      responseType = pt.tecnico.ttt.TransposeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.tecnico.ttt.TransposeRequest,
      pt.tecnico.ttt.TransposeResponse> getTransposeMethod() {
    io.grpc.MethodDescriptor<pt.tecnico.ttt.TransposeRequest, pt.tecnico.ttt.TransposeResponse> getTransposeMethod;
    if ((getTransposeMethod = TTTGrpc.getTransposeMethod) == null) {
      synchronized (TTTGrpc.class) {
        if ((getTransposeMethod = TTTGrpc.getTransposeMethod) == null) {
          TTTGrpc.getTransposeMethod = getTransposeMethod =
              io.grpc.MethodDescriptor.<pt.tecnico.ttt.TransposeRequest, pt.tecnico.ttt.TransposeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Transpose"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.ttt.TransposeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.ttt.TransposeResponse.getDefaultInstance()))
              .setSchemaDescriptor(new TTTMethodDescriptorSupplier("Transpose"))
              .build();
        }
      }
    }
    return getTransposeMethod;
  }
  ...
  public static abstract class TTTImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void transpose(pt.tecnico.ttt.TransposeRequest request,
        io.grpc.stub.StreamObserver<pt.tecnico.ttt.TransposeResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getTransposeMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pt.tecnico.ttt.TransposeRequest,
                pt.tecnico.ttt.TransposeResponse>(
                  this, METHODID_TRANSPOSE)))
          .build();
    }
  }
  ...
  public static final class TTTStub extends io.grpc.stub.AbstractAsyncStub<TTTStub> {
    ...
    public void transpose(pt.tecnico.ttt.TransposeRequest request,
        io.grpc.stub.StreamObserver<pt.tecnico.ttt.TransposeResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getTransposeMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class TTTBlockingStub extends io.grpc.stub.AbstractBlockingStub<TTTBlockingStub> {
    ...
    /**
     */
    public pt.tecnico.ttt.TransposeResponse transpose(pt.tecnico.ttt.TransposeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getTransposeMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class TTTFutureStub extends io.grpc.stub.AbstractFutureStub<TTTFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.tecnico.ttt.TransposeResponse> transpose(
        pt.tecnico.ttt.TransposeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getTransposeMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_TRANSPOSE = 3;
      ...
      switch (methodId) {
        ...
        case METHODID_CHECK_WINNER:
          serviceImpl.checkWinner((pt.tecnico.ttt.CheckWinnerRequest) request,
              (io.grpc.stub.StreamObserver<pt.tecnico.ttt.CheckWinnerResponse>) responseObserver);
          break;
        case METHODID_TRANSPOSE:
          serviceImpl.transpose((pt.tecnico.ttt.TransposeRequest) request,
              (io.grpc.stub.StreamObserver<pt.tecnico.ttt.TransposeResponse>) responseObserver);
          break;
        default:
